...
/*!******************************!*\
  !*** ./src/actions/index.ts ***!
  \******************************/
/*! exports provided: PUBLISH_EVENT, publishEvent, ADD_LOG_TO_HISTORY, addLogToHistory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PUBLISH_EVENT", function() { return PUBLISH_EVENT; });
...
/*!********************************!*\
  !*** ./src/event-publisher.ts ***!
  \********************************/
/*! exports provided: createEventPublisher */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _tracker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tracker */ "./src/middlewares/tracker.ts");


var middlewares = [_tracker__WEBPACK_IMPORTED_MODULE_1__["trackerMiddleware"], _logger__WEBPACK_IMPORTED_MODULE_0__["loggerMiddleware"]];
...
var loggerMiddleware = function (store) { return function (next) { return function (action) {
    ...
    if (action.type === _actions__WEBPACK_IMPORTED_MODULE_0__["PUBLISH_EVENT"] && action.data) {
        var _a = action.data, eventName = _a.name, payload = _a.payload;
        var date = new Date().toLocaleString();
        store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_0__["addLogToHistory"])({ date: date, eventName: eventName, payload: payload }));
...
/***/ "./src/middlewares/tracker.ts":
/*!************************************!*\
  !*** ./src/middlewares/tracker.ts ***!
  \************************************/
/*! exports provided: trackerMiddleware */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "trackerMiddleware", function() { return trackerMiddleware; });
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../actions */ "./src/actions/index.ts");
...
/***/ "./src/reducers/data-layer-reducer.ts":
/*!********************************************!*\
  !*** ./src/reducers/data-layer-reducer.ts ***!
  \********************************************/
/*! exports provided: dataLayerReducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dataLayerReducer", function() { return dataLayerReducer; });
/* harmony import */ var _actions_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/index */ "./src/actions/index.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ "./src/utils/index.ts");
...
var dataLayerReducer = function (state, action) {
    var _a;
    ...
    switch (action.type) {
        case _actions_index__WEBPACK_IMPORTED_MODULE_0__["PUBLISH_EVENT"]:
            ...
            if (name_1 === 'pageInfo') {
                ...
                return __assign(__assign({}, state), { page: {
                        pageId: pageId,
...
/*!*******************************!*\
  !*** ./src/reducers/index.ts ***!
  \*******************************/
/*! exports provided: dataLayerReducer, logsReducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _data_layer_reducer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data-layer-reducer */ "./src/reducers/data-layer-reducer.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "dataLayerReducer", function() { return _data_layer_reducer__WEBPACK_IMPORTED_MODULE_0__["dataLayerReducer"]; });

/* harmony import */ var _logs_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./logs-reducer */ "./src/reducers/logs-reducer.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "logsReducer", function() { return _logs_reducer__WEBPACK_IMPORTED_MODULE_1__["logsReducer"]; });
...
/***/ "./src/reducers/logs-reducer.ts":
/*!**************************************!*\
  !*** ./src/reducers/logs-reducer.ts ***!
  \**************************************/
/*! exports provided: logsReducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "logsReducer", function() { return logsReducer; });
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions */ "./src/actions/index.ts");
var __assign = (undefined && undefined.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
var logsReducer = function (state, action) {
    var _a;
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ADD_LOG_TO_HISTORY"]:
            var payload = action.payload;
            return __assign(__assign({}, state), { history: __assign(__assign({}, state.history), (_a = {}, _a[payload.date] = payload, _a)) });
        default:
            return state;
    }
};
...
/*!****************************!*\
  !*** ./src/utils/index.ts ***!
  \****************************/
/*! exports provided: modifyPublishedEventDataForStore, generateDimensionsObj */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modifyPublishedEventDataForStore = function (_a) {
    ...
    if (name === 'viewStep' || name === 'packagesComplete')
        return payload;
    if (name === 'originComplete')
        return { origin: payload };
    if (name === 'destinationComplete')
...
var generateDimensionsObj = function (tracker, dataLayerState) {
    ...
    return {
        ...
        dimension09: (rate === null || rate === void 0 ? void 0 : rate.currency) || '',
